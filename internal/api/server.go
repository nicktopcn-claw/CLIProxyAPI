...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/embeddings-compatibility", s.mgmt.GetEmbeddingsCompat)
		mgmt.PUT("/embeddings-compatibility", s.mgmt.PutEmbeddingsCompat)
		mgmt.PATCH("/embeddings-compatibility", s.mgmt.PatchEmbeddingsCompat)
		mgmt.DELETE("/embeddings-compatibility", s.mgmt.DeleteEmbeddingsCompat)
